...
export const servers = sqliteTable('servers', {
  ...
  serverJvmArgs: text('server_jvm_args'),
  ...
  majorUpdatePolicy: text('major_update_policy').$type<UpdatePolicy>(),
...
export const serverUpdateState = sqliteTable('server_update_state', {
  ...
  availableMajorVersion: text('available_major_version'),
  notifiedMajorVersion: text('notified_major_version'),
  ...
  desiredInstallLoader: text('desired_install_loader').$type<'forge' | 'neoforge' | 'fabric'>(),
  desiredInstallMcVersion: text('desired_install_mc_version'),
  desiredInstallLoaderVersion: text('desired_install_loader_version'),
